...
export function Footer() {
  return (
    <footer className="text-charcoal" style={{ backgroundColor: '#B3D4BC' }}>
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="mt-4 text-charcoal/80 max-w-sm leading-relaxed">
          ...
          {/* Experiencias */}
          <div>
            <h4 className="font-serif text-lg text-charcoal mb-4">Experiencias</h4>
          ...
          {/* Empresa */}
          <div>
            <h4 className="font-serif text-lg text-charcoal mb-4">Empresa</h4>
            <ul className="space-y-3">
          ...
          {/* Contact */}
          <div>
            <h4 className="font-serif text-lg text-charcoal mb-4">Contacto</h4>
            <ul className="space-y-3">
              <li className="flex items-center gap-2 text-charcoal/70 text-sm">
              ...
              <li>
                <a
                  ...
                  className="flex items-center gap-2 text-charcoal/70 hover:text-charcoal transition-colors text-sm"
                >
        ...
        {/* Bottom Bar */}
        <div className="border-t border-charcoal/20 py-6 flex items-center justify-center">
