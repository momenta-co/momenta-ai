/**
 * Catalog Section - What experiences are actually available
 *
 * This section changes when inventory/catalog is updated.
 * Team members working on catalog updates should edit this file.
 */
